...
| `ChiemTinh.gs` | Chiêm tinh: 12 cung, nhà Placidus, phẩm chất miếu/vượng/hãm/tù, góc chiếu có orb, nguyên tố – tính chất, pha Mặt Trăng, chủ tinh lá số, ngoại hình theo cung Mọc, dấu hiệu cơ thể (Sao Hỏa/Sao Thổ/nhà 6), gốc gác (nhà 4), nghề (MC), chu kỳ Sao Thổ/Sao Mộc/Thiên Vương/Nút theo ngày quá cảnh thực, hồ sơ năm (profection); **quy trình 7 bước** (`ctPhanTich_`): giờ sao, Nút Nam, Chiron, Lilith, Big Three, 12 nhà, cấu hình Stellium/T-Square/Grand Trine/Grand Cross/Yod, 8 lĩnh vực, transit – tiến triển – Solar Arc – Solar Return – Lunar Return, lời khuyên; `ctSoSanh_` cho Cặp đôi (nhà chồng lấn, Composite, Davison) |
| `HumanDesign.gs` | Human Design: 26 kích hoạt (Tính cách + Thiết kế 88°), 9 trung tâm, 36 kênh, Loại, Chiến lược, Thẩm quyền, Hồ sơ, Định nghĩa, Giao điểm hóa thân, sinh học trung tâm; **quy trình 11 bước** (`hdPhanTich_`): 5 loại, 7 thẩm quyền, định nghĩa + cổng cầu nối, 12 hồ sơ, 9 trung tâm, 36 kênh theo mạch, 64 cổng (đen/đỏ/treo/trống), 4 biến số (Động lực, Quan điểm, Môi trường, Tiêu hóa), hồi quy Mặt Trời, chu kỳ 7 năm, transit, luận tổng hợp |
| `ThanSoHoc.gs` | Thần số học: số chủ đạo (2–11, 22, 33), ngày sinh, thái độ, biểu đồ ngày sinh & 15 mũi tên, biểu đồ tên tiếng Việt (linh hồn, nhân cách, sứ mệnh, trưởng thành, cân bằng, bài học nghiệp, đam mê ẩn), 4 đỉnh cao – thử thách, năm/tháng cá nhân; **quy trình 6 bước** (`tsPhanTich_`): nợ nghiệp 13/14/16/19, tiềm thức, thách thức chính, số 0, số lặp, năm – tháng – ngày cá nhân, luận 5 lĩnh vực + bài học linh hồn, 5 lời khuyên, ô thử tên cho con |
...
| `ThanhToan.gs` | **Ví xu & mở khóa**: 1 xu = 1.000đ; nạp qua VietQR (payOS tự đối soát hoặc chủ sở hữu xác nhận thủ công); mở khóa theo từng lá số: Bản mở 49 xu (bản mệnh, vĩnh viễn) + **vận hạn bán theo giai đoạn** (1 đại vận 19 – vận đã qua 9, trọn 12 đại vận 99, vận năm 29/năm, nhật vận 9/tháng, Đồng hành cả năm 79) + chuyên đề (biến cố 29, phối ngẫu 19, PDF 29, dò giờ 19); Trọn đời 149 (trừ phần đã mua); gói gia đình 3 người 129 / 5 người 199 (lượt mở dùng cho lá số bất kỳ); chủ sở hữu & VIP toàn quyền; trang quản trị: doanh thu, đơn, tài khoản, bảng giá, cài đặt thanh toán |
| `BatTuPhanTich.gs` | **Phân tích Bát Tự 9 bước**: vượng suy (được lệnh, đắc địa, được sinh, được trợ + điểm Thiệu Vĩ Hoa: can 36°, chi 30° chia tàng can 60/30/10, hệ số mùa vượng–tướng–hưu–tù–tử), dụng thần (ức phù theo bảng ưu tiên, điều hậu, thông quan, bệnh dược), cách cục (chính cách, Kiến Lộc/Dương Nhận, Tòng Tài/Sát/Nhi, Chuyên vượng, Hóa khí), cát hung, 5 phương diện, luận đại vận (can 5 năm đầu, chi 5 năm sau), lưu niên đặc biệt (tuế vận tịnh lâm, thiên khắc địa xung, tam hình, Thiên La Địa Võng) |
...
| `HaLac.gs` | Bát Tự Hà Lạc: đổi tứ trụ ra số Hà Đồ – Lạc Thư, Thiên số/Địa số, quẻ Tiên thiên – Hậu thiên – Hỗ, hào nguyên đường theo giờ, đại vận theo 12 hào (dương 9 năm, âm 6 năm), quẻ lưu niên từng năm, chấm điểm theo cát/hung quẻ, vị hào và dụng thần; **lục hào nạp giáp** (bát cung, Thế – Ứng, lục thân, lục thú, phục thần, vượng suy theo tháng – ngày sinh, không vong, hào động hóa) và luận lục thân 8 lĩnh vực; hóa công – nguyên khí; quẻ Biến – Thác – Tổng |
...
| `CapDoi.gs` | **Xem cặp đôi (hợp hôn 2 lá số, 29 xu/cặp)**: 6 tiêu chí có trọng số – tuổi & ngũ hành năm sinh (chấm hai chiều), Bát Tự hợp hôn (nhật can, cung phu thê, dụng thần trao đổi, nguyệt trụ, thân vượng – nhược), Tử Vi (Mệnh – Phu Thê), chiêm tinh so sánh (15 cặp hành tinh), thần số, Human Design (kênh điện từ/đồng hành/thỏa hiệp); tình cảm, tài chính (ai giữ quỹ, ai vượng tài cho ai), công danh, gia đạo; năm cưới (tích xác suất 2 lá số, trừ Kim Lâu cô dâu, năm xung tuổi) và năm sinh con kèm %, số con, trai/gái; năm cả hai cùng thuận – cùng khó |
...
1. Dán mã, rồi trong trình soạn thảo chạy **`capQuyenThanhToan`** một lần để cấp quyền (gọi payOS, cài trigger) và tạo các trang tính `Vi`, `SoCai`, `MoKhoa`, `DonHang`, `Ve`. Triển khai lại Web App.
