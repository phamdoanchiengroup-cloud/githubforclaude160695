...
var HAM_CAN_CO = {
  ...
  'Astro.gs': 'astToanBo', 'ChiemTinh.gs': 'chiemTinhLap', 'HumanDesign.gs': 'hdLap', 'ThanSoHoc.gs': 'thanSoHocLap', 'TongHop.gs': 'tongHopLuan', 'PhoiNgau.gs': 'phoiNgauLuan', 'HaLac.gs': 'haLacLap', 'HoiTu.gs': 'htHoiTu_'
};
...
function kiemTraCaiDat() {
  var loi = kiemTraCaiDat_();
  if (!loi.length) { Logger.log('✔ Cài đặt đúng: đủ 15 file .gs và 3 file HTML.'); return; }
